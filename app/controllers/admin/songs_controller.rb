class Admin::SongsController < Admin::BaseController
  ...
  private
    ...
    def songs_params
      params.require(:song).permit(:artist_id, :artwork, :album_id, :track, :title, :features, :producer, :album_title, :release_date, :download_link, :embedded_code, :itunes, :google, :amazon, :spotify, :youtube)
    end
